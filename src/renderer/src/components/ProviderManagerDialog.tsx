...
import type { CustomProviderInput, CustomProviderProfile, ProviderConnectionDraft, ProviderDraftProbeResult, ProviderModelCandidate, ProviderModelDefinition, ProviderProtocol, ProviderSchemaProfile, ProviderUpstreamProtocol } from "../../../shared/types";
...
function presetDraft(preset: Preset): ProviderConnectionDraft {
  const base: ProviderConnectionDraft = { id: "custom", name: "自定义提供商", baseUrl: "https://api.example.com/v1", protocol: "chat_completions", upstreamProtocol: "openai_chat", schemaProfile: "standard", authScheme: "bearer", credentialMode: "managed", credentialValue: "", headers: [], models: [] };
