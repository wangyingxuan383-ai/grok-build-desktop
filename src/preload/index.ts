...
const api: GrokDesktopApi = {
  ...
  exportSessionTrace: (sessionId) => ipcRenderer.invoke("diagnostics:trace-export", sessionId),
  ...
  sendPrompt: (input) => ipcRenderer.invoke("session:send", input.sessionId, input.text, input.attachments, input.clientMessageId, input.draftKey, input.draftSubmissionId),
  getOfflineUiFixture: () => ipcRenderer.invoke("ui-fixture:get"),
  enqueuePrompt: (sessionId, text, attachments, clientMessageId, draftKey, draftSubmissionId) => ipcRenderer.invoke("session:enqueue", sessionId, text, attachments, clientMessageId, draftKey, draftSubmissionId),
  interjectPrompt: (sessionId, text, attachments, clientMessageId, draftKey, draftSubmissionId) => ipcRenderer.invoke("session:interject", sessionId, text, attachments, clientMessageId, draftKey, draftSubmissionId),
  ...
  rewindSession: (sessionId, pointId) => ipcRenderer.invoke("session:rewind", sessionId, pointId),
  ...
  respondMcpElicitation: (id, requestId, outcome, content) => ipcRenderer.invoke("mcp-elicitation:respond", id, requestId, outcome, content),
  respondPlan: (id, requestId, verdict, comment, executionMode) => ipcRenderer.invoke("plan:respond", id, requestId, verdict, comment, executionMode),
  ...
  listClaudeSessions: (cwd, force) => ipcRenderer.invoke("claude:list", cwd, force),
  openClaudeSession: (id) => ipcRenderer.invoke("claude:open", id),
  refreshClaudeSession: (id) => ipcRenderer.invoke("claude:refresh", id),
  hideClaudeSession: (id, hidden) => ipcRenderer.invoke("claude:hide", id, hidden),
  continueClaudeSession: (id) => ipcRenderer.invoke("claude:continue", id),
  ...
  setDraft: (key, text, capability, attachments, newTask, submissionId) => ipcRenderer.invoke("draft:set", key, text, capability, attachments, newTask, submissionId),
  ...
  previewCliUpdate: (policy, action) => ipcRenderer.invoke("cli:update-preview", policy, action),
  getCliUpdateState: () => ipcRenderer.invoke("cli:update-state"),
