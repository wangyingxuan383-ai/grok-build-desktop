...
| 2026-07-20 | 0.2.106 (`bde89716f6`) | Public app 0.5.8 release candidate | No Grok wire change: task-center system discovery is now sequential and its release-only isolated UI profile remains deterministic. Normal provider, automation, plugin, marketplace and MCP capability probing is unchanged. |
