...
| 2026-07-20 | 0.2.106 (`bde89716f6`) | Public app 0.5.5 release candidate | No Grok wire change: the release-only isolated UI profile now returns an empty plugin/Skill inventory without invoking CLI/ACP. Normal plugin, marketplace and MCP capability probing remains unchanged; 194 offline tests and both local 4K and hosted-runner UI branches passed. |
