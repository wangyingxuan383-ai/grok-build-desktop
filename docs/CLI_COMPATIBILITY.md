...
| 2026-07-20 | 0.2.106 (`bde89716f6`) | Public app 0.5.10 release candidate | No Grok wire change: task-center system discovery remains sequential. Hosted CI verifies the packaged shell and entry surface; local packaging retains real overlay interactions. Normal provider, automation, plugin, marketplace and MCP capability probing is unchanged. |
