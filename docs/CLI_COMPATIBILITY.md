...
| 2026-07-21 | 0.2.106 (`bde89716f6`) | Public app 0.5.11 release candidate | No Grok wire change: task-center system discovery remains sequential. Hosted acceptance now runs the headless Task Scheduler entry before its sole Renderer and defers downloaded Portable UI verification to a fresh runner. Normal provider, automation, plugin, marketplace and MCP probing is unchanged. |
