...
| 2026-07-20 | 0.2.106 (`bde89716f6`) | Public app 0.5.6 release candidate | No Grok wire change: the release-only isolated UI profile now returns an empty plugin/Skill inventory without invoking CLI/ACP. Normal plugin, marketplace and MCP capability probing remains unchanged; 194 offline tests, the local 4K long flow and the hosted-runner split-panel branch passed. |
