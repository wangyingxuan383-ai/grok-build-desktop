...
| 2026-07-20 | 0.2.106 (`bde89716f6`) | Public app 0.5.9 release candidate | No Grok wire change: task-center system discovery is sequential and the hosted package probe now uses one isolated Renderer. Normal provider, automation, plugin, marketplace and MCP capability probing is unchanged. |
