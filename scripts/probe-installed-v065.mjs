...
try {
  ...
  if (bootstrap.appVersion !== "0.6.5") throw new Error(`Main process reported ${bootstrap.appVersion}`);
  await evaluate("document.querySelector('.sidebar-footer button[title=\"版本与更新\"]')?.click(); true");
  await waitFor(() => evaluate("document.querySelector('.control-panel .about')?.innerText.includes('Grok Build Desktop 0.6.5')"), "About panel did not report 0.6.5");
